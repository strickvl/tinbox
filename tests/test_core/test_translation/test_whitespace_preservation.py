...
class TestWhitespacePreservationEndToEnd:
    ...
    def mock_completion_with_whitespace(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "tinbox.core.translation.litellm.completion", mock_completion
        )

    @pytest.mark.asyncio
    async def test_whitespace_preservation_end_to_end(
        self, mock_completion_with_whitespace
    ):
    ...
    @pytest.mark.asyncio
    async def test_whitespace_preservation_with_context(
        self, mock_completion_with_whitespace
    ):
